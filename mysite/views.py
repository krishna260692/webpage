...
def homecontact(request):
    ...
    if request.method == 'POST':
        ...
        tomessage = request.POST['comment']
        ...
        part = MIMEText(Environment().from_string(html).render(contact=mycontact,myname=fname,mymail=toemail,mymessage=tomessage  ),"html")
